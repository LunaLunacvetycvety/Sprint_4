...
text_accordion_heading_1 = (
    'Пока что у нас так: один заказ — один самокат. Если хотите покататься с друзьями, можете просто сделать несколько заказов — один за другим.')
text_accordion_heading_2 = (
...
text_accordion_heading_4 = (
    'Пока что нет! Но если что-то срочное — всегда можно позвонить в поддержку по красивому номеру 1010.')
text_accordion_heading_5 = (
    'Самокат приезжает к вам с полной зарядкой. Этого хватает на восемь суток — даже если будете кататься без передышек и во сне. Зарядка не понадобится.')
text_accordion_heading_6 = (
...
class MainPage:
    ...
    def click_popup_cookies(self):
        self.driver.find_element(*pop_up_agreement_cookies).click()

    @allure.step('Получение ответа на вопрос')
    def get_accordion_text(self, button_id, text_id):
        self.driver.find_element(*button_id).click()
        WebDriverWait(self.driver, 2).until(expected_conditions.visibility_of_element_located(text_id))
        return self.driver.find_element(*text_id).text
